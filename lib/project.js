...
module.exports = class Project {
  ...
  async hydratePrebuilds () {
    // TODO: download npm tarball
    // if (hasDependency(this.pkg, 'node-gyp-build', '>=4')) {
    //
    //   this.type = 'node-gyp-build@4'
    //   this.prebuilds = ngb4.prebuilds(/* tarballDir */)
    // } else if (hasDependency(this.pkg, 'node-gyp-build', '>=3')) {
    //   this.type = 'node-gyp-build@3'
    //   this.prebuilds = ngb3.prebuilds(/* tarballDir */)
    // }

    if (hasDependency(this.pkg, 'prebuild-install', '>=3')) {
      if (this.pkg.binary) {
